...
\subsection{Applying the Baker-Campbell-Hausdorff Lemma}
...
\subsection{Calculating the Nested Commutators}
...
\subsection{Summing the BCH Series}
...
\section{Derivation of the Normal-Ordered Squeezing Operator using Operator Algebra}
...
\subsection{Constructing the Normal-Ordered Ansatz}
...
\subsection{Pushing the Creation Operator Through the Ansatz}
...
\subsection{Pushing the Annihilation Operator Through the Ansatz}
...
\subsection{Determining the Normalization Scalar}
...
\subsection{Squeezed state form}
...
\subsection{The Annihilation Condition}
...
\subsection{Formulating $\hat{b}$ in Phase Space}
...
\subsection{Solving the Position Wavefunction}
...
\subsection{Integrating the Wigner Function}
...
\subsection{Normal-Ordered Ladder Expansion}
...
\subsection{The First Moments (Means)}
...
\subsection{The Variance / Squeezing Terms}
...
\subsection{Deriving the Input Covariance Matrix }
...
\subsection{Deriving the Symplectic Beam-Splitter Matrix }
...
\subsection{Deriving the Output EPR Covariance Matrix }
