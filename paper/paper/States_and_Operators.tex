...
\end{equation*}
Using the exact same vacuum evaluation rules established above (from the annihilation and creation operators' action on vacuum state), only the $\hat{a}\hat{a}^\dagger$ operator survives acting on $|0\rangle$:
\begin{equation*}
