...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/qsd.png}
    \caption{An overview of the central role of quantum state discrimination in quantum information theory.}
...
\begin{equation}
    \langle\psi_0|\psi_1\rangle = 0 \tag{1.20}
\end{equation}
